...
<div style="display: flex; flex-wrap: wrap; gap: 10px;">
    <a href="{{site.baseurl}}/oopdisplay" style="text-decoration: none;">
    ...
    <a href="{{site.baseurl}}/controls" style="text-decoration: none;">
    ...
    <a href="{{site.baseurl}}/datat" style="text-decoration: none;">
    ...
    <a href="{{site.baseurl}}/oper" style="text-decoration: none;">
        <div style="background-color: var(--orange); color: white; padding: 10px 20px; border-radius: 5px; font-weight: bold; transition: transform 0.2s, box-shadow 0.2s;">
           Operators
        </div>
    </a>
    <a href="{{site.baseurl}}/inp" style="text-decoration: none;">
        <div style="background-color: var(--blue); color: white; padding: 10px 20px; border-radius: 5px; font-weight: bold; transition: transform 0.2s, box-shadow 0.2s;">
           Input/Output
        </div>
    </a>
    ...
    <a href="{{site.baseurl}}/debug-doc" style="text-decoration: none;">
